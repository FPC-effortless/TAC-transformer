...
FILES = [
    ...
    "tac_transformer/structure_memory.py",
    "tac_transformer/concept_volumes.py",
    "tac_transformer/structure_routing.py",
    "tac_transformer/structure_slots.py",
    "tac_transformer/structure_bridge.py",
    "tac_transformer/structure_lifecycle.py",
    "tac_transformer/procedural_memory.py",
    "tac_transformer/repair_controller.py",
