...
def _parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    ...
    p.add_argument(
        "--ref",
        default="",
        help=("Branch/tag/commit the runner checked out. Recorded in the bundle "
              "for provenance; it does not select code."),
    )
    p.add_argument(
        "--quick",
        action="store_true",
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    bundle: Dict[str, Any] = {
        ...
        # Provenance: the revision the runner actually executed. The workflow
        # registers on main but checks out the research ref, so recording this
        # makes "which code produced this bundle" unambiguous in the artifact.
        "checked_out_ref": args.ref or None,
